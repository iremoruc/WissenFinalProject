...
namespace HotelProject.DataAccessLayer.Migrations
{
    ...
    [Migration("20231022192422_add_country-gender")]
    partial class add_countrygender
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concrete.Contact", b =>
                {
                    ...
                    b.Property<int>("MessageSubjectCategoryId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MessageSubjectCategoryId");
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concrete.MessageSubjectCategory", b =>
                {
                    b.Property<int>("MessageSubjectCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("MessageSubjectCategoryId");

                    b.ToTable("MessageSubjectCategories");
                });
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concrete.Contact", b =>
                {
                    b.HasOne("HotelProject.EntityLayer.Concrete.MessageSubjectCategory", "MessageSubjectCategory")
                        .WithMany("Contacts")
                        .HasForeignKey("MessageSubjectCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MessageSubjectCategory");
                });
